...
export const AuthGate: React.FC<AuthGateProps> = ({
  ...
  const handleLoginSuccess = () => {
    // Authentication state is refreshed by useAuth.
  };

  if (authLoading || (currentUser && workspaceLoading)) {
    return (
      <div className="min-h-screen bg-[#0F172A] flex flex-col justify-center items-center font-sans space-y-4">
        <div className="relative flex items-center justify-center">
          <div className="absolute w-16 h-16 bg-[#818CF8]/25 rounded-full animate-ping" />
